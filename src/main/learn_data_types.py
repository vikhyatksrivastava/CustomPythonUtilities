...
def test_numeric():
    ...
    print(f"Sum of two int data i.e {int_num} and {int_num} is {int_add}")
    #2. Float
    print(f"This is float data", {float_num})
    print(f"Product of two float data i.e {float_num} and 4.2 is ({float_num} * 4.2). Round of result is (round({float_num} * 4.2, 2))")
    #3. Complex Number
